...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <form method="post" action="/admin/admin/main_edit" id="app">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">原密码：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="old_pwd" value="" class="text-word old_pwd">
        	<span style="margin-left: 20px; display: none;">请输入原密码！</span>
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input name="" type="submit" onclick="return confirm('确定修改吗？')" value="提交" class="text-but">
...
<script type="text/javascript">
	$('.old_pwd').focus(function(){
		...
		if($(this).val()!=''){
			...
			$(this).siblings('span').html('请输入原密码').css('color','#000000');
		}
	...
	$('.old_pwd').blur(function(){
		if($(this).val()!=''){
			...
			$.post('/admin/admin/pwd',{pwd:$('.old_pwd').val()},function(data){
				console.log(data);
				if(data==1){
					$('.old_pwd').siblings('span').html('正确，请输入新密码！').css('color','#0088cc');
				}else{
					$('.old_pwd').siblings('span').html('用户名密码错误，请从新输入！').css('color','#0088cc');
				}
			})
		}else if($(this).val()==''){
			$(this).siblings('span').html('请输入原密码').css('color','#000000');
