...
.sns-config {
    ...
    border-bottom: 0;
    background-color: #fff;
}.tab-app li.selected a {
    height: 24px;
    line-height: 23px;
}.tab-app li.selected a, .tab-app li.selected a:visited {
    color: #333;
    ...
    z-index: 10;
    margin: 0 3px;
}.sns-tab ul.tab-sub li, .tab-sub ul li {
    border: 0;
    margin-bottom: 0;
    background: 0 0;
}.sns-tab ul li a {
    ...
    padding: 0 10px;
    text-decoration: none;
}.sns-tab ul.tab-sub li a, .sns-tab ul.tab-sub li a:visited, .tab-sub li a, .tab-sub li a:visited {
    height: 25px;
    line-height: 25px;
    color: #313131;
    text-decoration: none;
    font-weight: 100;
}.sns-tab ul.tab-sub li.selected a, .sns-tab ul.tab-sub li.selected a:visited, .tab-sub li.selected a, .tab-sub li.selected a:visited {
    color: #666;
    font-weight: 700;
    border: 0;
    text-decoration: none;
	...
	<body>
		...
		<ul>
			<li class="selected">
	            ...
	            <div class="bd">
	                <div class="sns-nf">
	                                                                                <div class="tips-box">亲爱的<b>浮***丝</b>，填写真实的资料，有助于好友找到你哦。</div>
	                <form id="baseInfoForm" name="baseInfoForm" method="post" class="infoForm">
	                    <input name="_tb_token_" type="hidden" value="eeb569133d8f">
	                    ...
	                    <div id="main-profile" class="parts">
	                        <p>
	                            ...
	                            <span class="pf-avatar-box">
	                                <a class="pf-avatar">
	                                    <img src="//wwc.alicdn.com/avatar/getAvatar.do?userId=1906690648&amp;width=80&amp;height=80&amp;type=sns">
	                                                                    </a>
	                        ...
	                        <p>
	                            ...
	                            <input id="J_uniqueName-mask" class="f-txt" type="text" value="" maxlength="25">
	                        ...
	                        <p>
	                            ...
	                            <label for="J_gender1" class="except"><input id="J_gender1" type="radio" name="_fm.b._0.g" value="0">男</label>
